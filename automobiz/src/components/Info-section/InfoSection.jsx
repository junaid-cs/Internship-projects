...
const InfoSection = () => {
  return (
    <div className='container-fluid bg-darkish h-100vh overflow-hidden'>
      <div className="container d-flex justify-content-between mt-5 h-100 ">

      <div className='car_img_section text-white w-25 position-relative'>
